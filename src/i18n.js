...
export const T = {
  ...
  nav: {
    ...
    merchandise:{ en: "Merchandise",fr: "Marchandise",ja: "グッズ",   pt: "Produtos",    ro: "Produse"    },
  ...
  overview: {
    ...
    body1:       { en: "SubmitologY is a Singapore-based Brazilian Jiu-Jitsu (BJJ) community, apparel and merchandise brand targeting the mid-range quality segment across Singapore and Southeast Asia. The brand is built on a distinctive social mission: using BJJ as a vehicle for mental health awareness, recovery, and community resilience.", fr: "SubmitologY est une marque communautaire de Jiu-Jitsu Brésilien (BJJ), de vêtements et de produits dérivés basée à Singapour, ciblant le segment de qualité moyenne-supérieure à Singapour et en Asie du Sud-Est. La marque repose sur une mission sociale distinctive : utiliser le BJJ comme vecteur de sensibilisation à la santé mentale, de rétablissement et de résilience communautaire.", ja: "SubmitologYはシンガポールを拠点とするブラジリアン柔術（BJJ）コミュニティ・アパレル・グッズブランドで、シンガポールおよび東南アジア全域のミッドレンジ品質層をターゲットとしています。ブランドは独自の社会的使命に基づいて構築されています：BJJをメンタルヘルスの啓発、回復、そしてコミュニティのレジリエンスを促進する手段として活用することです。", pt: "SubmitologY é uma marca de comunidade, vestuário e produtos de Brazilian Jiu-Jitsu (BJJ) sediada em Singapura, voltada para o segmento de qualidade intermediária em Singapura e no Sudeste Asiático. A marca é construída sobre uma missão social distinta: usar o BJJ como veículo para a conscientização sobre saúde mental, recuperação e resiliência comunitária.", ro: "SubmitologY este un brand de comunitate, îmbrăcăminte și produse pentru Jiu-Jitsu Brazilian (BJJ), cu sediul în Singapore, care se adresează segmentului de calitate medie din Singapore și Asia de Sud-Est. Brandul este construit pe o misiune socială distinctă: folosirea BJJ ca vehicul pentru conștientizarea sănătății mintale, recuperare și reziliență comunitară." },
    ...
    merchCta:    { en: "Merchandise",          fr: "Marchandise",               ja: "グッズ",           pt: "Produtos",            ro: "Produse" },
  ...
  // ── MERCHANDISE ──────────────────────────────────────────────────────────
  merch: {
    pageTitle:    { en: "Merchandise",   fr: "Marchandise",       ja: "グッズ",         pt: "Produtos",         ro: "Produse"        },
    pageSubtitle: { en: "Apparel and gear from SubmitologY.", fr: "Vêtements et équipements SubmitologY.", ja: "SubmitologYのアパレルとギア。", pt: "Vestuário e equipamentos SubmitologY.", ro: "Îmbrăcăminte și echipamente SubmitologY." },
    comingSoon:   { en: "Coming soon",   fr: "Bientôt disponible",ja: "近日公開",        pt: "Em breve",         ro: "În curând"      },
    comingSoonSub:{ en: "We're building our apparel and merchandise line. Check back soon.", fr: "Nous préparons notre gamme de vêtements et de produits dérivés. Revenez bientôt.", ja: "アパレルおよびグッズラインを準備中です。近日中に再度ご確認ください。", pt: "Estamos preparando nossa linha de vestuário e produtos. Volte em breve.", ro: "Pregătim linia noastră de îmbrăcăminte și produse. Reveniți în curând." },
  },
